		...
		<tbody>
			<?php while ($row=mysqli_fetch_array($results)){ ?>
				<tr>
					...
					<td>
						<a class="editbtn" href="std_admin.php?edit=<?php echo $row['sno']; ?>">Edit</a>
					</td>
					<td>
						<a class="delbtn" href="std_admin1.php?delete=<?php echo $row['sno']; ?>">Delete</a>
					</td>
				</tr>
			<?php } ?>
		</tbody>
	</table>
	<form method="post" action="std_admin1.php">
